...
class SynthesizerTrn(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.flow_from_text = ResidualCouplingTransformersBlock(
            inter_channels,
            hidden_channels,
            5,
            1,
    ...
    def forward(self, x, x_lengths, y, y_lengths, sid=None):
        ...
        x_flown = self.flow_from_text(z_p, y_mask, g=g, reverse=True)
        with torch.no_grad():
        ...
        x_expanded = torch.matmul(attn.squeeze(1), x.transpose(1, 2)).transpose(1, 2)
    ...
    def infer(
        ...
        z_p = self.flow_from_text(z_p, y_mask, g=g)
